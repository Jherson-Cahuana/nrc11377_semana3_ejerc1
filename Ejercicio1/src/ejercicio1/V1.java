...
public class V1 extends JFrame implements ActionListener {
	...
	public V1() {
		...
		}
		{
			...
			lblNewLabel_1.setBounds(10, 38, 81, 14);
		...
		}
		{
			...
			lblNewLabel_3.setBounds(89, 64, 57, 14);
			contentPane.add(lblNewLabel_3);
		}
		{
			txtN1 = new JTextField();
			txtN1.setBounds(211, 8, 86, 20);
			contentPane.add(txtN1);
			txtN1.setColumns(10);
		}
		{
			txtN2 = new JTextField();
			txtN2.setBounds(211, 35, 86, 20);
			contentPane.add(txtN2);
			txtN2.setColumns(10);
		}
		{
			txtN3 = new JTextField();
			txtN3.setBounds(211, 61, 86, 20);
		...
		}
		{
			...
			btnNewButton.setBounds(376, 7, 113, 23);
			contentPane.add(btnNewButton);
		}
		{
			btnNewButton_1 = new JButton("Suma 3 enteros");
			btnNewButton_1.addActionListener(this);
			btnNewButton_1.setBounds(376, 38, 113, 23);
			contentPane.add(btnNewButton_1);
		}
		{
			btnNewButton_2 = new JButton("Suma 2 reales");
			btnNewButton_2.addActionListener(this);
			btnNewButton_2.setBounds(376, 72, 113, 23);
			contentPane.add(btnNewButton_2);
		}
		{
			scrollPane = new JScrollPane();
			scrollPane.setBounds(10, 131, 507, 145);
